...
function viewComputerSelection(computerWeapon) {
  ...
  if (computerWeapon === 'rock') {
    computerButton.children[0].src = computerButton.children[0].src.replace(/rock-right|paper-right|scissors-right/, 'rock-right');
    computerButton.children[1].textContent = 'ROCK';
  }
  else if (computerWeapon === 'paper') {
    computerButton.children[0].src = computerButton.children[0].src.replace(/rock-right|paper-right|scissors-right/, 'paper-right');
    computerButton.children[1].textContent = 'PAPER';
  }
  else if (computerWeapon === 'scissors') {
    computerButton.children[0].src = computerButton.children[0].src.replace(/rock-right|paper-right|scissors-right/, 'scissors-right');
